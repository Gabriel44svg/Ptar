...
-- 100% Compatible con SQLAlchemy Models
-- ====================================================================
...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    correo VARCHAR(255) UNIQUE NOT NULL,       -- Corregido: correo
    password_hash VARCHAR(255) NOT NULL,       -- Corregido: password_hash
    rol VARCHAR(50) NOT NULL DEFAULT 'Lector',
    fecha_creacion TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP -- Agregado
);
...
VALUES ('Super Administrador', 'admin@fes.unam.mx', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Super Admin')
